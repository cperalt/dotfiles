...
const vec4 TRAIL_COLOR = vec4(0.490, 0.812, 1.0, 1.0);       // #7dcfff tokyonight cyan
const vec4 TRAIL_COLOR_ACCENT = vec4(0.616, 0.604, 0.969, 1.0); // #9d9af7 slightly deeper purple
