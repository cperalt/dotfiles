...
export type VimState = { mode: "insert" } | { mode: "normal"; command: CommandState };
...
export const SIMPLE_MOTIONS = new Set<MotionKey>(["h", "j", "k", "l", "w", "e", "b", "W", "E", "B", "0", "^", "$"]);

export const OPERATOR_MOTIONS = new Set<MotionKey>(["h", "l", "w", "e", "b", "W", "E", "B", "0", "^", "$"]);
