...
const ADD_ROW_BACKGROUND_MIX_RATIO = 0;
const REMOVE_ROW_BACKGROUND_MIX_RATIO = 0;
const ADD_INLINE_EMPHASIS_MIX_RATIO = 0.28;
const REMOVE_INLINE_EMPHASIS_MIX_RATIO = 0.2;
